...
(2, 'Blender', 'Rueda Calendarica', 'Informacion', '<h2>Proyecto de Blender: Simulación del Calendario</h2>\n\n<p>Este proyecto de Blender está diseñado para simular el funcionamiento del calendario maya, mostrando cómo se interrelacionan los diferentes ciclos calendáricos.</p>\n\n<h3>Descripción del Proyecto</h3>\n\n<p>En esta simulación, hemos modelado la Rueda del Calendario Maya, representando el ciclo de 52 años que es crucial en su sistema de tiempo. La simulación ilustra cómo los días en los ciclos Tzolkin y Haab se alinean y coinciden a lo largo del tiempo.</p>\n\n<h3>Colaboración y Descargas</h3>\n\n<p>Para contribuir a la elaboración de este proyecto de Blender puedes ingresar al siguiente link <a href="https://srlabs.a2hosted.com/rs-humhub/index.php?r=wiki%2Fpage%2Fview&title=Proyecto+Tiempo+Maya&cguid=03ab5d70-702f-4844-a654-5f47fd6a1f61">SrLabs</a>, acontinuacion encontrarás enlaces para descargar los archivos:</p>\n\n<ul><li><a href="https://drive.google.com/drive/folders/1boSl4LLjeey-g1qPK5_mAZxUzrnKKMHV?usp=sharing" class="btn btn-primary">Descargar Modelo Blender</a></li>\n\n</ul>'),
